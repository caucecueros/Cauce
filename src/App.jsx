...
function App() {
  ...
  return (
    <>
      ...
      <div style={{ minHeight: '100vh', fontFamily: 'serif', backgroundImage: "url('/pantalla5.jpg')", backgroundSize: 'cover', backgroundPosition: 'center', backgroundAttachment: 'fixed' }}>
