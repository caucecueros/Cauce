...
export default function Catalogo({ volver, onAgregar, seccionActiva, setSeccionActiva }) {
  ...
  const seccionesProductos = {
    ...
    brazaletes: {
      titulo: 'BRAZALETES',
      items: [{ id: 10, nombre: 'Brazalete Clásica', img: '/brazalete1.png' },
              { id: 11, nombre: 'Brazalete Cruadrada', img: '/brazalete2.png' },
              { id: 12, nombre: 'Brazelete Gruesa', img: '/brazalete3.png' },
              { id: 13, nombre: 'Brazalete Tachas', variantes: [{ id: 131, nombre: 'Brazalete Tachas Marron', img: '/brazalete4.png', material: 'Bronce' }, { id: 132, nombre: 'Brazalete Tachas Negro', img: '/brazalete5.png', material: 'Plata' }] },
      ]
    }
  };
