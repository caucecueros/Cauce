...
export default function Catalogo({ volver, onAgregar, seccionActiva, setSeccionActiva }) {
  ...
  const seccionesProductos = {
    armados: {
      titulo: 'CINTURONES',
      items: [
        { id: 7, nombre: 'Cinto Clásica', desc: 'Diseño clásico correntino.', img: '/CinturonSimple.png' },
        { id: 8, nombre: 'Cinto Clásico', desc: 'Diseño clásico correntino.', img: '/CinturonSimplo.png' },
        { id: 9, nombre: 'Cinto Chata', desc: 'Costura manual reforzada.', img: '/CinturonRaro.png' },
        { id: 10, nombre: 'Cinto Puntera', desc: 'Cuero engrasado de alta resistencia.', img: '/CinturonRedondo.png' },
        ...
        { id: 15, nombre: 'Cinto Terra', desc: 'Diseño clásico correntino.', img: '/CinturonTerra.png' },
        { id: 16, nombre: 'Cinto Cora', desc: 'Diseño clásico correntino.', img: '/CinturonCora.png' },        
        { id: 17, nombre: 'Cinto Sol', desc: 'Hebilla artesanal con baño de metal.', variantes: [{ id: 171, nombre: 'Cinto Sol Bronce', img: '/CinturonEstrella.png', material: 'Bronce' }, { id: 172, nombre: 'Cinto Sol Plata', img: '/CinturonEstrella2.png', material: 'Plata' }] },
        { id: 18, nombre: 'Cinto Ovál', desc: 'Hebilla artesanal con baño de metal.', variantes: [{ id: 181, nombre: 'Cinto Ovál Bronce', img: '/CinturonCircular1.png', material: 'Bronce' }, { id: 182, nombre: 'Cinto Ovál Plata', img: '/CinturonCircular2.png', material: 'Plata' }] },
        { id: 19, nombre: 'Cinto Potro', desc: 'Hebilla artesanal con baño de metal.', variantes: [{ id: 191, nombre: 'Cinto Potro Bronce', img: '/CinturonPerro.png', material: 'Bronce' }, { id: 192, nombre: 'Cinto Potro Plata', img: '/CinturonPerro2.png', material: 'Plata' }] },     
      ]
    },
    brazaletes: {
      titulo: 'BRAZALETES',
